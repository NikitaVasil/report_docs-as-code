...
&$exe $md -o $tempdocx --lua-filter ./source/linebreaks.lua --filter pandoc-crossref --citeproc --reference-doc $template
...
if ($embedfonts) {
  ...
  # $word.ActiveDocument.Selection.Font.Size = 14
  # $word.ActiveDocument.Selection.Font.Name = "Times New Roman"
