# Практическое применение инструментов подхода "Документация как код"
...
2. применение тех же инструментов, что и при разработке ПО;
3. удобное отслеживание изменений в версиях документов;
4. улучшения качества документации (автоматические проверки, такие как линтеры и тесты, могут быть применены к документации так же, как и к коду);
5. снижает затраты на поддержку и обновление документации (уменьшает риск возникновения устаревшей или некорректной документации);
6. задел на будущее для разработки внутреннего портала документации.
